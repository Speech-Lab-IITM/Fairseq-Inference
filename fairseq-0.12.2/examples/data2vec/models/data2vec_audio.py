...
class Data2VecAudioModel(BaseFairseqModel):
    def __init__(self, cfg: Data2VecAudioConfig):
        ...
        # BEGIN additional module for data2vec-aqc
        final_dim = 768 # for large  # for base 256
        vq_dim = cfg.latent_dim if cfg.latent_dim > 0 else final_dim
        self.quantizer = GumbelVectorQuantizer(
                dim=self.extractor_embed, #self.embed
        ...
        # END additional module for data2vec-aqc
        ...
        # BEGIN additional module for data2vec-aqc
        self.contr_proj = nn.Linear(self.embed, final_dim)
        # END additional module for data2vec-aqc
